...
```sh
$ go get -u github.com/RohanPoojary/chromedp
```
...
* [`github.com/RohanPoojary/chromedp-proxy`][chromedp-proxy] - a simple CDP proxy for logging CDP clients and browsers

[chromedp-ci]: https://github.com/RohanPoojary/chromedp/actions/workflows/test.yml (Test CI)
[chromedp-ci-status]: https://github.com/RohanPoojary/chromedp/actions/workflows/test.yml/badge.svg (Test CI)
[chromedp-examples]: https://github.com/chromedp/examples
[chromedp-pdlgen]: https://github.com/chromedp/pdlgen
[chromedp-proxy]: https://github.com/RohanPoojary/chromedp-proxy
[devtools-protocol]: https://chromedevtools.github.io/devtools-protocol/
[docker-headless-shell]: https://hub.docker.com/r/chromedp/headless-shell/
[github-326]: https://github.com/RohanPoojary/chromedp/issues/326
...
[goref-chromedp-exec-allocator]: https://pkg.go.dev/github.com/RohanPoojary/chromedp#example-ExecAllocator
[goref-chromedp]: https://pkg.go.dev/github.com/RohanPoojary/chromedp
[goref-chromedp-status]: https://pkg.go.dev/badge/github.com/RohanPoojary/chromedp.svg
[release-status]: https://img.shields.io/github/v/release/chromedp/chromedp?display_name=tag&sort=semver (Latest Release)
[releases]: https://github.com/RohanPoojary/chromedp/releases (Releases)
